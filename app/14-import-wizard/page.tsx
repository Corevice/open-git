...
const items: ImportItem[] = [
  ...
  { id: "pr", icon: "🔀", title: "Pull Requests", desc: "PR・レビュー・コメント・マージ履歴", count: "8,921 件のPR（うちOpen: 412）" },
  ...
  return (
    <div className="min-h-screen bg-[#f6f8fa] text-[#1f2328]">
      ...
      <div className="bg-[#24292f] text-white px-6 py-3 flex items-center justify-between">
        ...
        <div>
          <Link href="/05-repo-list" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium text-[#c9d1d9] hover:text-white">
            マイリポジトリ
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-8">
        ...
        <div className="flex justify-center items-center max-w-[720px] mx-auto mb-10">
          ...
          <div className="flex-1 h-0.5 bg-[#1f883d] -mx-5 -mt-7 self-center min-w-[40px]" />
          <div className="flex flex-col items-center min-w-[120px]">
            <div className="w-10 h-10 rounded-full flex items-center justify-center font-semibold bg-[#1f883d] text-white border-2 border-[#1f883d]">✓</div>
          ...
          <div className="flex-1 h-0.5 bg-[#eaeef2] -mx-5 -mt-7 self-center min-w-[40px]" />
          <div className="flex flex-col items-center min-w-[120px]">
        ...
        <form onSubmit={handleSubmit} className="max-w-[600px] mx-auto bg-white border border-[#d0d7de] rounded-lg overflow-hidden">
          <div className="px-6 py-5 border-b border-[#d0d7de]">
            <h2 className="text-[18px] font-bold mb-1">移行対象を選択</h2>
            <p className="text-[#656d76] text-sm">インポートするデータの種類を選んでください</p>
          </div>
          <div className="p-6">
            <div className="bg-[#ddf4ff] border border-[#54aeff66] rounded-md px-3.5 py-3 text-[13px] text-[#0550ae] mb-5 flex gap-2">
              <span>ℹ️</span>
              <div>
            ...
            <div className="flex flex-col gap-3">
              {items.map((item) => (
                <label
                  key={item.id}
                  className="flex items-start gap-3 px-3.5 py-3 border border-[#d0d7de] rounded-md cursor-pointer hover:bg-[#f6f8fa]"
                >
                  <input
                    type="checkbox"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-[#656d76] mt-0.5">{item.desc}</div>
                    <div className="text-xs text-[#0969da] font-medium mt-1">{item.count}</div>
                  </div>
                </label>
              ))}
            </div>
        ...
        <div className="max-w-[600px] mx-auto mt-4 flex justify-between items-center">
          <Link href="/05-repo-list" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium text-[#656d76] hover:bg-[#f6f8fa]">
            ✕ キャンセル
          </Link>
          <div className="flex gap-2">
            <Link href="/14-import-wizard" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium bg-white text-[#1f2328] border border-[#d0d7de] hover:bg-[#f6f8fa]">
              ← 戻る
            </Link>
            <Link href="/07-repo-detail" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md text-sm font-medium bg-[#1f883d] text-white border border-[rgba(31,35,40,0.15)] hover:bg-[#1a7f37]">
              インポート実行 →
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-[600px] mx-auto mt-10">
          <details className="bg-white border border-[#d0d7de] rounded-lg px-4 py-3">
            ...
            <div className="mt-4 text-center">
              ...
              <div className="w-full h-2 bg-[#eaeef2] rounded overflow-hidden my-5">
