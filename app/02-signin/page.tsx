    ...
    <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] font-sans">
      <div className="max-w-[340px] mx-auto px-5 py-10">
        ...
        <div className="bg-[#161b22] border border-[#30363d] rounded-md p-4 mb-4">
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-[#0d1117] border border-[#30363d] rounded-md text-[#c9d1d9] text-sm leading-5 outline-none focus:border-[#58a6ff]"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full block text-center bg-[#238636] hover:bg-[#2ea043] text-white border border-white/10 px-4 py-2 rounded-md text-sm font-semibold cursor-pointer"
            >
              サインイン
            </button>
          </form>
          ...
          <Link
            href="/04-dashboard"
            className="flex items-center justify-center gap-2 w-full px-4 py-2 bg-[#21262d] hover:bg-[#30363d] text-[#c9d1d9] border border-[#30363d] rounded-md text-sm font-medium mb-2"
          >
          ...
          <Link
            href="/04-dashboard"
            className="flex items-center justify-center gap-2 w-full px-4 py-2 bg-[#21262d] hover:bg-[#30363d] text-[#c9d1d9] border border-[#30363d] rounded-md text-sm font-medium"
          >
            <span className="text-base">🐙</span>
        ...
        <div className="mt-12 text-center text-xs text-[#8b949e]">
          <Link href="/02-signin" className="text-[#58a6ff] hover:underline mx-2">
            利用規約
          </Link>
          <Link href="/02-signin" className="text-[#58a6ff] hover:underline mx-2">
            プライバシー
