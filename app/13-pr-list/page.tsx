    ...
    <div className="min-h-screen bg-[#f6f8fa]">
      <header className="h-16 bg-white/85 backdrop-blur border-b border-[#d0d7de] flex items-center justify-between px-6 sticky top-0 z-[100]">
        ...
        <div className="flex items-center gap-4">
          <Link href="/12-issue-list" className="text-sm text-[#24292f] hover:text-[#0969da]">
            Issues
          </Link>
          <Link href="/13-pr-list" className="text-sm text-[#24292f] hover:text-[#0969da]">
            Pull Requests
          </Link>
      ...
      <div className="bg-white px-6 pt-5 pb-3 border-b border-[#d0d7de]">
        <h1 className="m-0 text-xl font-normal">
          📦{' '}
          <Link href="/07-repo-detail" className="text-[#0969da] no-underline">
            octocat
          </Link>{' '}
          / <strong className="font-semibold text-[#0969da]">hello-world</strong>{' '}
          <span className="ml-2 text-xs px-2 py-0.5 rounded-full bg-[#ddf4ff] text-[#0969da] border border-[#0969da]/20">
            Public
          </span>
        </h1>
      </div>
      ...
      <nav className="bg-white border-b border-[#d0d7de] px-6 flex gap-1">
        <Link
          href="/07-repo-detail"
          className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-transparent hover:bg-[#f6f8fa]"
        >
          &lt;&gt; Code
        </Link>
        <Link
          ...
          className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-transparent hover:bg-[#f6f8fa]"
        >
          ⊙ Issues <span className="ml-1 text-xs bg-[#eaeef2] px-1.5 py-0.5 rounded-full">42</span>
        </Link>
        <Link
          href="/13-pr-list"
          className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-[#fd8c73] font-semibold"
        >
          ⇆ Pull Requests{' '}
          <span className="ml-1 text-xs bg-[#eaeef2] px-1.5 py-0.5 rounded-full">8</span>
        </Link>
        <Link
          href="/13-pr-list"
          className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-transparent hover:bg-[#f6f8fa]"
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="bg-[#f6f8fa] border border-[#d0d7de] rounded-t-lg px-4 py-3 flex gap-4 text-sm mt-6">
          <Link href="/13-pr-list" className="text-[#24292f] font-semibold">
            🟢 6 Open
          </Link>
          <Link href="/13-pr-list" className="text-[#57606a]">
            ✓ 124 Closed
          </Link>
        ...
        <div className="bg-white border border-t-0 border-[#d0d7de] rounded-b-lg mb-6">
          {prList.map((pr) => (
            ...
            >
              <span
                className={`text-lg ${pr.state === 'draft' ? 'text-[#6e7781]' : pr.state === 'conflicts' ? 'text-[#cf222e]' : 'text-[#1f883d]'}`}
              >
                ⇆
              </span>
              <div className="flex-1">
                <Link
                  href="/13-pr-list"
                  className="text-[15px] font-semibold text-[#24292f] hover:text-[#0969da] no-underline"
                >
                  {pr.title}
                </Link>
                {pr.state === 'ready' && (
                  <span className="ml-2 text-xs px-2 py-0.5 rounded-full bg-[#dafbe1] text-[#1a7f37]">
                    Ready
                  </span>
                )}
                {pr.state === 'draft' && (
                  <span className="ml-2 text-xs px-2 py-0.5 rounded-full bg-[#eaeef2] text-[#57606a]">
                    Draft
                  </span>
                )}
                {pr.state === 'conflicts' && (
                  <span className="ml-2 text-xs px-2 py-0.5 rounded-full bg-[#ffebe9] text-[#cf222e]">
                    Conflicts
                  </span>
                )}
                <div className="text-xs text-[#57606a] mt-1">
                  #{pr.id} {pr.meta} by <strong>{pr.author}</strong> · {pr.checks}
                </div>
              </div>
          ...
          <div className="flex justify-between items-start gap-4 mb-3">
            <div>
              <h2 className="m-0 text-[22px] font-semibold">
                ...
                <span className="text-[#6e7781] font-normal">#247</span>
              </h2>
              <div className="flex items-center gap-2 flex-wrap text-[13px] text-[#57606a] mt-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#1f883d] text-white text-[13px] font-medium">
                  🟢 Open
                </span>
                <span>
            ...
            <div className="flex gap-2">
              <Link
                href="/13-pr-list"
                className="text-sm px-3 py-1.5 border border-[#d0d7de] rounded-md bg-white text-[#24292f] hover:bg-[#f6f8fa]"
              >
                ✏ Edit
              </Link>
              <Link
              ...
              <Link
                href="/13-pr-list"
                className="text-sm px-3 py-1.5 border border-[#cf222e] rounded-md bg-white text-[#cf222e] hover:bg-[#ffebe9]"
              >
                ✕ Close
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 pb-6">
          <div>
            ...
            <div className="flex gap-0 bg-white border border-b-0 border-[#d0d7de] rounded-t-lg px-4">
              <Link
                href="/13-pr-list"
                className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-[#fd8c73] font-semibold inline-flex items-center gap-2"
              >
                💬 Conversation{' '}
                <span className="text-xs bg-[#eaeef2] px-1.5 py-0.5 rounded-full">5</span>
              </Link>
              <Link
                href="/13-pr-list"
                className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-transparent hover:text-[#0969da] inline-flex items-center gap-2"
              >
                ⊙ Commits <span className="text-xs bg-[#eaeef2] px-1.5 py-0.5 rounded-full">3</span>
              </Link>
              <Link
                href="/13-pr-list"
                className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-transparent hover:text-[#0969da] inline-flex items-center gap-2"
              >
                ✓ Checks <span className="text-xs bg-[#eaeef2] px-1.5 py-0.5 rounded-full">12</span>
              </Link>
              <Link
                href="/13-pr-list"
                className="px-4 py-3.5 text-sm text-[#24292f] border-b-2 border-transparent hover:text-[#0969da] inline-flex items-center gap-2"
              >
                📄 Files changed{' '}
                <span className="text-xs bg-[#eaeef2] px-1.5 py-0.5 rounded-full">7</span>
              </Link>
            </div>
            ...
            <div className="bg-white border border-[#d0d7de] rounded-b-lg p-5">
              ...
              <div className="border border-[#d0d7de] rounded-lg mb-4 overflow-hidden">
                ...
                <div className="p-4 text-sm leading-relaxed">
                  <p>
                    This PR adds full dark mode support to the user settings page. Users can now
              ...
              <div className="border border-[#d0d7de] rounded-lg mb-4 overflow-hidden">
                <div className="bg-[#f6f8fa] px-4 py-2.5 border-b border-[#d0d7de] mono text-[13px] flex justify-between">
                  ...
                  <span>
                    <span className="text-[#1a7f37]">+42</span>{' '}
                    <span className="text-[#cf222e]">-8</span>
                  </span>
                </div>
              ...
              <div className="border border-[#d0d7de] rounded-lg mb-4 overflow-hidden">
                ...
                <div className="p-4 text-sm leading-relaxed">
                  <p>
                    Could we also add a smooth transition animation when toggling themes? Otherwise
                    looks great.
                  </p>
                </div>
              </div>
              ...
              <div className="border border-[#d0d7de] rounded-lg p-4 mt-4 bg-white flex items-center gap-4">
                ...
                <Link
                  href="/13-pr-list"
                  className="px-4 py-2 bg-[#1f883d] text-white rounded-md text-sm font-medium hover:bg-[#1a7f37]"
                >
                  Merge pull request ▾
                </Link>
              </div>
              ...
              <form
                ...
                className="bg-white border border-[#d0d7de] rounded-lg p-4 mt-4"
              >
                ...
                <div className="flex gap-2 mt-3 flex-wrap">
                  <button
                    type="submit"
                    className="px-3 py-1.5 text-sm bg-[#f6f8fa] border border-[#d0d7de] rounded-md text-[#24292f] hover:bg-[#eaeef2]"
                  >
                    Comment
                  </button>
                  <button
                    type="button"
                    className="px-3 py-1.5 text-sm bg-[#1f883d] text-white rounded-md hover:bg-[#1a7f37]"
                  >
                    ✓ Approve
                  </button>
                  <button
                    type="button"
                    className="px-3 py-1.5 text-sm bg-white border border-[#d0d7de] rounded-md text-[#24292f] hover:bg-[#f6f8fa]"
                  >
                    Request changes
                  </button>
                </div>
          ...
          <aside>
            <div className="bg-white border border-[#d0d7de] rounded-lg p-4 mb-4">
              <h4 className="m-0 mb-3 text-[13px] text-[#57606a] uppercase tracking-wider">
                Reviewers
              </h4>
            ...
            <div className="bg-white border border-[#d0d7de] rounded-lg p-4 mb-4">
              ...
              <div className="flex gap-1.5 flex-wrap">
                <span className="text-xs px-2 py-0.5 rounded-full bg-[#ddf4ff] text-[#0969da]">
                  enhancement
                </span>
                <span className="text-xs px-2 py-0.5 rounded-full bg-[#fef3c7] text-[#9a6700]">
                  ui
                </span>
                <span className="text-xs px-2 py-0.5 rounded-full bg-[#dafbe1] text-[#1a7f37]">
                  good first review
