  ...
  return (
    <div className="min-h-screen bg-[#f6f8fa]">
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-[#d1d9e0] bg-white/85 px-6 backdrop-blur">
        <Link href="/" className="flex items-center gap-2 text-lg font-extrabold text-[color:var(--text-primary)]">
          <span className="text-xl">🐙</span>
          <span>OpenHub</span>
        </Link>
        <div className="flex items-center gap-2">
          <Link href="/05-repo-list" className="rounded-md px-3 py-1.5 text-sm font-medium text-[color:var(--text-secondary)] hover:bg-[#f6f8fa]">
            リポジトリ
          </Link>
          <Link href="/05-repo-list" className="rounded-md px-3 py-1.5 text-sm font-medium text-[color:var(--text-secondary)] hover:bg-[#f6f8fa]">
            マイページ
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-[1fr_auto_2fr] items-end gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-md border border-[#d1d9e0] bg-white px-3 py-2 text-sm focus:border-[#0969da] focus:outline-none focus:ring-2 focus:ring-[#0969da]/20"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-[#d1d9e0] px-3 py-2 text-sm focus:border-[#0969da] focus:outline-none focus:ring-2 focus:ring-[#0969da]/20"
                />
              </div>
            </div>
            <div className="mt-1.5 text-[13px] text-[#1f883d]">
              ✓ 利用可能な名前です。 <span className="font-mono text-[color:var(--text-muted)]">{owner}/{repoName}</span>
            </div>
          ...
          <div className="rounded-md border border-[#d1d9e0] bg-[#f6f8fa] p-4">
            ...
            <div className="flex items-start gap-2.5 py-2">
              ...
              />
              <div>
                <label htmlFor="init-readme" className="text-sm font-medium">README ファイルを追加</label>
            ...
            <div className="flex items-start gap-2.5 py-2">
              ...
              />
              <div>
                <label htmlFor="init-gitignore" className="text-sm font-medium">.gitignore を追加</label>
                <div className="mt-0.5 text-[13px] text-[#59636e]">
            ...
            <div className="mb-3 ml-[30px] mt-2">
              <label htmlFor="gitignore-template" className="mb-1.5 block text-sm font-semibold">.gitignore テンプレート</label>
              <select
            ...
            <div className="flex items-start gap-2.5 py-2">
              ...
              />
              <div>
                <label htmlFor="init-license" className="text-sm font-medium">ライセンスを選択</label>
                <div className="mt-0.5 text-[13px] text-[#59636e]">
            ...
            <div className="ml-[30px] mt-2">
              <label htmlFor="license" className="mb-1.5 block text-sm font-semibold">ライセンス</label>
              <select
                id="license"
                value={license}
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              className="rounded-md bg-[#1f883d] px-4 py-2 text-sm font-medium text-white hover:bg-[#1a7a35]"
            >
              <Link href="/07-repo-detail" className="text-white">リポジトリを作成</Link>
            </button>
          </div>
        </form>
      </div>
