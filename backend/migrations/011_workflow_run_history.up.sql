...
ALTER TABLE workflow_jobs ADD COLUMN started_at TIMESTAMP;
ALTER TABLE workflow_jobs ADD COLUMN runner_name TEXT NOT NULL DEFAULT '';
ALTER TABLE workflow_jobs ADD COLUMN runner_labels TEXT NOT NULL DEFAULT '[]';
